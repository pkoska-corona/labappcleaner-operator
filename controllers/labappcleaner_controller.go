...
//+kubebuilder:rbac:groups=cleaner.example.com,resources=labappcleaners,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cleaner.example.com,resources=labappcleaners/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cleaner.example.com,resources=labappcleaners/finalizers,verbs=update
